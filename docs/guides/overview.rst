...
Gaze Data Outlet
****************
The default name of the gaze data stream is **pl_companion_Gaze**. This name will also show in the LabRecorder.
...
Event Data Outlet
*****************
The default name of the event stream is **pl_companion_Event**.
